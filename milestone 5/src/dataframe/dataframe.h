...
class DataFrame : public Object {
 public:
   ...
   */
  static DataFrame* fromFile(const char* filename) {
    Schema s;
  ...
  static DataFrame* fromFile(const char* filename, Key* key, KDStore* kv);

  static DataFrame* fromScalarInt(Key* key, KDStore* kv, int num);
